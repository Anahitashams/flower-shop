        ...
        <>
            <div className="parent flex-col flex-wrap justify-center">
                <div className='flex justify-center'>
                    <div className='w-[300px] h-[300px] m-[3px] relative overflow-hidden'><img className='w-full h-full hover:scale-110 transition-transform duration-1000' src="../public/img/buy-plants.jpg.webp" alt="" />
                    </div>
